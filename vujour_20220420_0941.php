            ...
            <?php for ($heure = 00; $heure < 24; $heure++) {
                ...
                <tr class="calendar">
                    ...
                    <td id="h<?= $heure; ?>"> <?php
                        ...
                        //
                        //                                ?>
                        <!--                                <div title="Rdv de --><?//= $heuredebut; ?><!-- à -->
                        <?//= $heurefin; ?><!-- --><?//= $rowrdv['Objet_RendezVous']; ?><!-- "-->
                        <!--                                     class="badge bg-danger"-->
                        <!--                                     style="height: --><?//= ($hdiff); ?>/*px;max-height:
                        109px; min-height: 45px;width: 20%">*/
                        /* Rdv de */<?//= $heuredebut;vujour.php ?>
                        <!--                                    à --><?//= $heurefin; ?><!-- -->
                        <?//= $rowrdv['Objet_RendezVous']; ?><!-- </div>-->
                        <!--                                --><?php
                        //                            }
                        //                            ?>
                        <!--                            --><?php
